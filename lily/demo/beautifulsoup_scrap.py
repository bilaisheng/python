#!usr/bin/python3
# -*- coding:utf-8 -*-
# Filename : beautifulsoup_scrap.py
# Author by : Lily
"""
用BeautifulSoup模块抓取数据
"""
...
print(html.h1)
# 输出h1,noscript标签中的内容
print(html.find_all({'h1', 'noscript'}))
# 找到属性是id=places_area__row的标签及里面的内容
area = html.find(attrs={'id': 'places_area__row'})
# 在area中找到属性是class=w2p_fw的标签里面的内容
result = area.find(attrs={'class': 'w2p_fw'}).text
